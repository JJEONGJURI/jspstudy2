...
<%--/jspstudy2/src/main/webapp/jstl/jstlfnEx1.jsp --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
<c:set var="str1" value="Functions <태그>를 사용합니다.                 "/> <%--F 는  0 --%>
...
substring(str1,3,6)=${fn:substring(str1,3,6)}:str1의 3~5 인덱스 부분문자열<br>
...
contains(str1,str2)=${fn:contains(str1,str2)}:str1내에 str2 문자열 존재?<br> <%--true / false --%>
...
join(arr,"-")=${fn:join(arr,"-")} : 배열을 하나의 문자열로 연결시켜 출력<br>
</body>
</html>