...
<%--/jspstudy2/src/main/webapp/el/elEx1.jsp --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<%
	//request.setCharacterEncoding("UTF-8"); //없으면 파라미터 한글값 깨짐 속성은 상관없음.
...
pageContext text 속성값 : <%=pageContext.getAttribute("test") %><br>
...
==	${test} : 영역담당 객체에 저장된 속성 중 이름이 test인 속성값을 출력
	...
	2. 1번의 내용이 없으면, requestScop 영역에 등록된 requestScope.test 속성 값 리턴
	3. 1,2번의 내용이 없으면, session 영역에 등록된 sessionScope.test 속성 값 리턴
	4. 1,2,3번의 내용이 없으면, application 영역에 등록된 applicationScope.test 속성 값 리턴
	5. 1,2,3,4번의 내용이 없으면 공란을 리턴
